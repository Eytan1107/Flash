                ...
                if (sender.hasPermission("flash.staff")) {
                    when {
                        args.contains("hub") -> {
                            ...
                            target.sendMessage("You have been teleported to &lHub&r &6by &l$sender".prefix())
                            //player.teleport(Bukkit.getServer("hub").spawnLocation)
                            return true
                        }
                        args.contains("kitpvp") -> {
                            ...
                            target.sendMessage("You have been teleported to &lKitPvP&r &6by &l$sender".prefix())
                            //player.teleport(Bukkit.getServer("kitpvp").spawnLocation)
                            return true
                        }
                        args.contains("skyblock") -> {
                            ...
                            target.sendMessage("You have been teleported to &lSkyBlock&r &6by &l$sender".prefix())
                            //player.teleport(Bukkit.getServer("skyblock").spawnLocation)
                            return true
                        }
                        args.contains("builds") -> {
                            if (sender.hasPermission("flash.staff")) {
                                if (target.hasPermission("flash.staff")) {
                                    sender.sendMessage("You Teleported &l${target.name}&r &6to &lBuilds".prefix())
                                    target.teleport(Bukkit.getWorld("builds").spawnLocation)
                                    target.sendMessage("You have been teleported to &lBuilds&r &6by &l$sender".prefix())
                                    //player.teleport(Bukkit.getServer("builds").spawnLocation)
                                    return true
                        ...
                        args.contains("tntrun") -> {
                            ...
                            target.sendMessage("You have been teleported to &lTnTRun&r &6by &l$sender".prefix())
                            //player.teleport(Bukkit.getServer("tntrun").spawnLocation)
                            return true
                        }
                        args.contains("event") -> {
                            ...
                            target.sendMessage("You have been teleported to &lEvent&r &6by &l$sender".prefix())
                            //player.teleport(Bukkit.getServer("event").spawnLocation)
                            return true
                    }
                }
                }
            } else player.sendMessage("Sorry that not how it works.".error())
        }
            return true
    }
}