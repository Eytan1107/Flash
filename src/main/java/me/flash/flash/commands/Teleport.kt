    ...
    override fun onCommand(sender: CommandSender, command: Command, label: String, args: Array<out String>): Boolean {
        if (args.isEmpty()) {
            ...
            if (from == sender) {
                ...
                if (!to.hasPermission("flash.msg.nice")) to.sendMessage("&c${sender.name} &6teleported to you.".prefix()) else to.sendMessage("&c${sender.name} &6teleported to you.".prefix())
                ...
                if (!sender.hasPermission("flash.msg.nice")) sender.sendMessage("Teleporting &c${from.name} &6to you".prefix()) else sender.sendMessage("Teleporting &l${from.name} &6to you".prefix())
